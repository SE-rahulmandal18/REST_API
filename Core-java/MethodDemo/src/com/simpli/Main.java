...
public class Main {
	...
	public static void main(String[] args) {
		...
		EmpInfo e3 = new EmpInfo(2,"rahul", 25000);
		System.out.println("Employee details of e2 : id="+ e2.id + ", name=" + e2.name + ", salary="+ e2.salary);
	    System.out.println("Employee details of e3 : id="+ e3.id + ", name=" + e3.name + ", salary="+ e3.salary);
