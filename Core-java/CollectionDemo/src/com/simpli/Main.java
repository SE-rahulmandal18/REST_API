...
public class Main {
	...
	public static void main(String[] args) {
		...
		// Vector
				...
				cityListVector.addElement("Bangalore");
				cityListVector.addElement("Delhi");
				cityListVector.addElement("Vishakapatinam");
				cityListVector.addElement("Patna");

				// Navigate and print each element of the cityListVector
				System.out.println("List of cities in cityListVector using simplied for loop \n");
				for (String city : cityListVector) {
					System.out.println(city);
				}
